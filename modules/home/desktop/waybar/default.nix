        ...
        mainBar = {
          ...
          "clock" = {
            ...
            "calendar" = {
              ...
              "on-scroll" = 1;
              "format" = {
                "months" = "<span color='#${config.host.theme.colors.pallete.base0A.hex}'><b>{}</b></span>";
                "days" = "<span color='#${config.host.theme.colors.pallete.base05.hex}'><b>{}</b></span>";
                "weeks" = "<span color='#${config.host.theme.colors.pallete.base0B.hex}'><b>W{}</b></span>";
                "weekdays" = "<span color='#${config.host.theme.colors.pallete.base09.hex}'><b>{}</b></span>";
                "today" = "<span color='#${config.host.theme.colors.pallete.${config.host.theme.colors.accent}.hex}'><b><u>{}</u></b></span>";
              };
            };
            "actions" = {
              "on-click-right" = "mode";
